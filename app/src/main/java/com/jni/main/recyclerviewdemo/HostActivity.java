...
public class HostActivity extends AppCompatActivity {
    ...
    public void onContentChanged() {
        ...
        btnAdditem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mList.size()<10) {
                    ...
                    Toast.makeText(HostActivity.this, "数量够了", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        findViewById(R.id.btn_switchlayout).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HostActivity.this, "调用了", Toast.LENGTH_SHORT).show();
                mAdapter.notifyDataSetChanged();
            }
        });
    ...
    class HostAdapter extends RecyclerView.Adapter<HostAdapter.HostViewHoder>{
        ...
        public HostViewHoder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new HostViewHoder(LayoutInflater.from(HostActivity.this).inflate(R.layout.item,parent,false));
        }

        @Override
        public void onBindViewHolder(HostViewHoder holder, final int position) {
            manager= (WindowManager) HostActivity.this.getSystemService(Context.WINDOW_SERVICE);
